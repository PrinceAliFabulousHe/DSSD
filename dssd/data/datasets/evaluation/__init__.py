from dssd.data.datasets import VOCDataset, COCODataset, HuBMAP
from .coco import coco_evaluation
from .voc import voc_evaluation
from .hubmap import hubmap_evaluation
...
def evaluate(dataset, predictions, output_dir, **kwargs):
    ...
    elif isinstance(dataset, HuBMAP):
        return hubmap_evaluation(**args)
    else:
